...
class SuccessfulTransferCommunique(TransferStatusCommunique):
    def __init__(
            self,
        ...
        super().__init__(
            ...
            port=port,
            checksum=checksum,
            status_code=StatusCode.SUCCESSFUL_TRANSFER
        )
    ...
    def is_message(message: str):
        ...
        if has_fields:
            ...
            has_right_status = fields[2] == StatusCode.SUCCESSFUL_TRANSFER.value
